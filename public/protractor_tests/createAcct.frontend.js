...
describe('account creation', function() {
	...
	var fillDependentsInfo = function(date, dependentIndex) {
		...
		element(by.xpath('//*[@id="dependents' + dependentIndex + '"]//*[@id="datetimepicker"]/input')).clear()
		element(by.xpath('//*[@id="dependents' + dependentIndex + '"]//*[@id="datetimepicker"]/input')).sendKeys(date)
